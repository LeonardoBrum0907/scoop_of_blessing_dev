...
const Section3 = () => {
      ...
      return (
            <Section id="section-3" className="bg-[url('/assets/imagenspipo/img_video_bg.png')] bg-cover bg-center flex items-center justify-center md:justify-end  gap-4">
                  <div className='md:w-2/5 bg-background-color p-4 rounded-[2rem] md:bg-transparent'>
                        <h1 className='mb-4 title text-pink text-[4rem] personalized-tracking'>Team delicious</h1>
