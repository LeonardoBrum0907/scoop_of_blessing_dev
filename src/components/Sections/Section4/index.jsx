...
const Section4 = () => {
      ...
      return (
            <Section id="section-4 " className="bg-background-color flex flex-col items-center">
                  <h1 className=" text-orange title text-[4rem] w-5/6 text-center">Crafted with care. Shared with love.</h1>
