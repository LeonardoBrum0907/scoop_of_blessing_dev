...
const Section6 = () => {
   ...
   return (
      <div className='flex justify-center w-full relative'>
         <Section id="section-6" className="w-full flex flex-col justify-center items-center gap-[4rem] xl:flex-row xl:h-[45rem] xl:py-[0]">
            <div id="section6-left" className="xl:h-full xl:w-1/2">
               <img src="/assets/imagenspipo/map_texas_scoop.png" alt="mapa" className="h-full w-full object-contain rounded-3xl" />
            </div>

            <div id="section6-right" className="w-full md:w-[90%] lg:w-[80%] xl:w-1/2 bg-white rounded-3xl flex flex-col items-center justify-center gap-2 px-10 py-12 z-10">
